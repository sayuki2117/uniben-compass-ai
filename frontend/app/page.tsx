...
export default function Home() {
  ...
  return (
    <main className="flex h-screen overflow-hidden bg-[#FBF7FC]">
      <ChatSidebar
        chats={chats}
      ...
      <section className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="border-b border-[#D4AF37]/30 bg-white px-4 py-3">
          <div className="mx-auto flex max-w-4xl flex-wrap items-center gap-3">
            ...
            <select
              ...
              className="rounded-md border border-[#D4AF37]/60 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-[#92049A] focus:ring-2 focus:ring-[#D4AF37]/25"
            >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6">
          <div className="mx-auto flex max-w-4xl flex-col gap-4">
            {activeChat?.messages.length === 0 ? (
              <div className="rounded-lg border border-[#D4AF37]/35 bg-white p-6 shadow-sm">
                <div className="mb-4 grid h-12 w-12 place-items-center rounded-md border border-[#D4AF37]/40 bg-[#92049A]/10 text-[#92049A]">
                  <Sparkles size={24} />
                </div>
